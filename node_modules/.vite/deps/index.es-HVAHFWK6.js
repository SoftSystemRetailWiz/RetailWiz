...
var apply, call2, uncurryThis, fixRegExpWellKnownSymbolLogic2, fails, anObject2, isCallable, isNullOrUndefined2, toIntegerOrInfinity, toLength2, toString2, requireObjectCoercible2, advanceStringIndex2, getMethod2, getSubstitution, regExpExec2, wellKnownSymbol, REPLACE, max, min, concat, push, stringIndexOf, stringSlice, maybeToString, REPLACE_KEEPS_$0, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE, REPLACE_SUPPORTS_NAMED_GROUPS;
...
var $, uncurryThis2, getOwnPropertyDescriptor, toLength3, toString3, notARegExp, requireObjectCoercible3, correctIsRegExpLogic, IS_PURE, stringSlice2, min2, CORRECT_IS_REGEXP_LOGIC, MDN_POLYFILL_BUG;
...
var globalThis2, DOMIterables, DOMTokenListPrototype, ArrayIteratorMethods, createNonEnumerableProperty, setToStringTag, wellKnownSymbol2, ITERATOR, ArrayValues, handlePrototype, COLLECTION_NAME;
...
var $3, uncurryThis3, getOwnPropertyDescriptor2, toLength4, toString4, notARegExp2, requireObjectCoercible4, correctIsRegExpLogic2, IS_PURE2, slice, min3, CORRECT_IS_REGEXP_LOGIC2, MDN_POLYFILL_BUG2;
...
var call3, uncurryThis4, fixRegExpWellKnownSymbolLogic3, anObject3, isNullOrUndefined3, requireObjectCoercible5, speciesConstructor, advanceStringIndex3, toLength5, toString5, getMethod3, regExpExec3, stickyHelpers, fails2, UNSUPPORTED_Y, MAX_UINT32, min4, push2, stringSlice3, SPLIT_WORKS_WITH_OVERWRITTEN_EXEC, BUGGY;
var init_es_string_split = __esm({
  "node_modules/core-js/modules/es.string.split.js"() {
    ...
    BUGGY = "abbc".split(/(b)*/)[1] === "c" || // eslint-disable-next-line regexp/no-empty-group -- required for testing
...
svg-pathdata/lib/SVGPathData.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index.es-HVAHFWK6.js.map
